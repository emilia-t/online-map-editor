    ...
    <div class="addNewConnectBoard" ref="addNewConnectBoard"><!--中间的实际面板-->
      ...
      <div class="AncContent"><!--内容-->
        ...
        <div class="AncList AncList2"><!--单条目-->
          ...
          <div class="AncInput"><!--输入框-->
            <form><input ref="AccountInput" placeholder="" type="text" name="account" id="account" autocomplete="off"/></form>
        ...
        <div class="AncList AncList3"><!--单条目-->
          ...
          <div class="AncInput"><!--输入框-->
            <form><input ref="PasswordInput" placeholder="" type="password" name="password" autocomplete="off" maxlength="20"/></form>
