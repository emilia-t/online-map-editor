...
<div class="BananaLoginBoard">
  <div v-if="!isLogin" class="session"><!--登录面板-->
    ...
    <div class="log-in" id="LinkPage">
      ...
      <div class="floating-label">
        <input @focus="onFocusMode()" @blur="noFocusMode()" placeholder="Password" type="password" name="password" id="password1" autocomplete="on" v-model:value="password">
  ...
  <div v-if="isLogin" class="session"><!--已登录面板-->
    ...
    <div class="log-in" id="LinkPage">
      ...
      <div class="floating-label">
        <input @focus="onFocusMode()" @blur="noFocusMode()" placeholder="Password" type="password" name="password" id="password2" autocomplete="on" v-model:value="password">
