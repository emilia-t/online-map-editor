...
<div class="BananaLoginBoard">
  ...
  <div v-if="!isLogin" class="session">
    ...
    <div class="log-in" id="LinkPage">
      ...
      <div class="floating-label">
        <input placeholder="Password" type="password" name="password" id="password1" autocomplete="off" v-model:value="password">
  ...
  <div v-if="isLogin" class="session">
    ...
    <div class="log-in" id="LinkPage">
      ...
      <div class="floating-label">
        <input placeholder="Email" type="email" name="email" id="email2" autocomplete="off" v-model:value="email">
      ...
      <div class="floating-label">
        <input placeholder="Password" type="password" name="password" id="password2" autocomplete="off" v-model:value="password">
