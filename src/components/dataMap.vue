    ...
    return{
      theConfig:{
          ...
          screenConfig:{
            ...
            //地图的实际大小，单位:M
            widthForReal:40075000,
            heightForReal:40075000,
          },
          //默认层级(一般用在第一次打开地图时)
          //放大与缩小幅度配置
          zoomAmplitudeConfig:{
  ...
  methods:{
    ...
    */
    ...
    "createTestLine"(){
      ...
      //设置配置文件
      let lineConfig={
        "startPointX":[9500,9641.4,10000,10000,10000,10000,9000,9000,0,0,-1000,20037500],//单位为现实世界中的M
        "startPointY":[9800,9941.4,10000,10000,10000,10000,9000,9000,0,0,-1000,20037500],//单位为现实世界中的M
        "angle":[45,-10,45,135,225,315,57,142,0,90,0,56],//deg
        "lengths":[200,200,300,300,300,300,200,200,20000,20000,20000,50000],//单位为现实世界中的M
        //不需要处理的选项
        "width":1,//虚拟的像素
        "background":"blue",//颜色
      };
